...
2. 共识过程
   ...
   ![](../pics/paxos_progress.png)
   
   上图就是描述了这么一个过程：
   
   ![](../pics/1553940469.jpeg)
...
![](../pics/basic_paxos_recovery.png)

从上帝视角，我们知道V1和V2是已经commit的，但是当S2宕机后，V2从原来的多数派，变成个不过半的少数派，这个时候无法确认V2是否已经commit过了。

![](../pics/basic_paxos_recovery2.png)

（1）可能的场景1：V2未commit

![](../pics/basic_paxos_commit.png)

（2）可能的场景2：V2已经commit

![](../pics/basic_paxos_commit2.png)
...
> 
> ![](../pics/basic_paxos_recovery3.png)
> 
> ![](../pics/basic_paxos_recovery4.png)

## 2.3 工程问题

（1）活锁问题

![](../pics/paxos_live_lock.png)
...
1. 幽灵复现
   ...
   > 
   > ![](../pics/paxos_ghost_log5.png)
   > 
   > ![](../pics/paxos_ghost_log6.png)
   > 
   > P2,6 是新Leader当选消息，又因为日志号需要保持递增，所以P1.7-10日志被丢弃（不会被重新提议）
   > 
   > ![](../pics/paxos_ghost_log7.png)
   > 
